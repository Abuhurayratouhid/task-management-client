        ...
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-violet-400 text-white mx-auto my-10">
            ...
            <form onSubmit={handleSignUp} className="space-y-6 ng-untouched ng-pristine ng-valid">
                <div className="space-y-1 text-sm">
                    ...
                    <input type="text" name="name" id="username" placeholder="Username" className="w-full px-4 py-3 rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-violet-600" />
                </div>
                <div className="space-y-1 text-sm">
            ...
            <p className="text-xs text-center sm:px-6 ">Already have an account?
                <Link to='/login' className="underline text-violet-800">Login</Link>
            </p>
        </div>
    );
};
